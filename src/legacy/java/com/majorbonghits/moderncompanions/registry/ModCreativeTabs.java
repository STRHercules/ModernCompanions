...
public final class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MAIN = TABS.register("modern_companions",
    ...
    private static void addBookLevels(CreativeModeTab.Output output, net.minecraft.core.Holder<net.minecraft.world.item.enchantment.Enchantment> holder) {
        for (int level = 1; level <= 3; level++) {
            ItemStack stack = EnchantedBookItem.createForEnchantment(new EnchantmentInstance(holder.value(), level));
